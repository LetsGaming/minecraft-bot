/**
 * Per-player session tracking — single owner of data/sessions.json.
 *
...
const SESSIONS_PATH = path.resolve(getRootDir(), "data", "sessions.json");

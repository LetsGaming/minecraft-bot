...
vi.mock("../../src/core/utils/minecraft/whitelist.js", () => ({
...
import { summarizeConfigChanges } from "../../src/core/utils/config/configDiff.js";
import { versionAtLeast } from "../../src/core/utils/server/serverAccess.js";
import { highestCrossed } from "../../src/bot/logWatcher/watchers/monitors/milestoneWatcher.js";
import { rewardPoolForServer } from "../../src/core/utils/stores/dailyStore.js";
import {
  pollServerIds,
  getOpenPollForServer,
  type Poll,
  type PollStore,
} from "../../src/core/utils/stores/pollStore.js";
import {
  parseScheduleTime,
  nextScheduledRun,
} from "../../src/bot/logWatcher/watchers/schedulers/restartScheduler.js";
import {
  buildActivitySparkline,
  busiestHours,
  type HourBucket,
} from "../../src/core/utils/stores/playerCountHistory.js";
import { sanitizeLogLine } from "../../src/bot/logWatcher/watchers/log/consoleRelay.js";
import {
  takeMatchingWatches,
  loadWatchStore,
  type WatchStore,
} from "../../src/core/utils/stores/watchStore.js";
import { kvSet } from "../../src/core/db/kv.js";
import { closeDbForTesting } from "../../src/core/db/index.js";
import { buildStreakLeaderboard } from "../../src/core/utils/minecraft/streakLeaderboard.js";

...
vi.mock("../../src/core/utils/minecraft/modUtils.js", () => ({
  getModList: vi.fn(),
}));
...
import { resolveServer } from "../../src/bot/utils/guild/guildRouter.js";
import { getLinkedAccount } from "../../src/core/utils/stores/linkUtils.js";
import { getModList } from "../../src/core/utils/minecraft/modUtils.js";
...
describe("serverAccess.logStreamUrl", () => {
  ...
  beforeEach(async () => {
    ({ logStreamUrl } = await import("../../src/core/utils/server/serverAccess.js"));
  });
...
describe("discordChannel — renameVoiceChannelIfChanged", () => {
  ...
  beforeEach(async () => {
    ({ renameVoiceChannelIfChanged } =
      await import("../../src/bot/utils/guild/discordChannel.js"));
  });

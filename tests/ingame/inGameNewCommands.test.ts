...
describe("!report handler", () => {
  ...
  beforeEach(async () => {
    const p = capture();
    (await import("../../src/bot/logWatcher/commands/communication/report.js")).init();
...
describe("!waypoint handler routing", () => {
  ...
  beforeEach(async () => {
    const p = capture();
    (await import("../../src/bot/logWatcher/commands/general/waypoint.js")).init();
    ({ regex, handler } = await p);
  });
...
describe("!vote handler", () => {
  ...
  beforeEach(async () => {
    const p = capture();
    (await import("../../src/bot/logWatcher/commands/general/vote.js")).init();
    ({ regex, handler } = await p);
  });
...
describe("!slime handler", () => {
  ...
  beforeEach(async () => {
    const p = capture();
    (await import("../../src/bot/logWatcher/commands/info/slime.js")).init();
    ({ regex, handler } = await p);
  });
...
describe("!deathpos handler", () => {
  ...
  beforeEach(async () => {
    const p = capture();
    (await import("../../src/bot/logWatcher/commands/info/deathpos.js")).init();
    ({ regex, handler } = await p);
  });
